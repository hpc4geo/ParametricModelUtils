...
class ParametricScheduler:
  ...
  where all model output should be written is created by ParametricScheduler.
  Futhermore, ParametricScheduler will set the value of `model.output_path` with a value consistent with the
  values in the parameter trajectory. The value of `model.output_path` set is an absolute path.
  ...
  Please refer to `.run_jobs()` for further information related to how ParametricScheduler interacts with ParametricModel.
